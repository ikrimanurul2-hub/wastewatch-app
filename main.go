...
func main() {
	// Mengambil kredensial dari Environment Variables (diset nanti di EC2/GitHub Actions)
	...
	http.HandleFunc("/upload", func(w http.ResponseWriter, r *http.Request) {
		...
		// Inisialisasi Sesi AWS S3
		sess, err := session.NewSession(&aws.Config{
			Region: aws.String("ap-southeast-1"), // Region Singapore
		})
